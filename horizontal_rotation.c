...
/*   Updated: 2024/03/01 16:54:33 by stouitou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	upd_all_ord(t_plane plane, t_view *view)
{
	...
	if (!view->x_vect_hor_ax)
		view->x_vect_ord = upd_ord_vector(view->x_vect_angle_hor, plane.x_scale);
	...
	if (!view->y_vect_hor_ax)
		view->y_vect_ord = upd_ord_vector(view->y_vect_angle_hor, plane.y_scale);
	...
	if (!view->z_vect_hor_ax)
		view->z_vect_ord = upd_ord_vector(view->z_vect_angle_hor, plane.z_scale);
