...
/*   Updated: 2024/03/01 16:53:12 by stouitou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	vertical_rotation(t_plane plane, t_view *view, int rotation)
{
	...
	if (!view->z_vect_vert_ax)
	{
		...
		check_my_axis_z(view, view->hor_rot, view->vert_rot);
	}
